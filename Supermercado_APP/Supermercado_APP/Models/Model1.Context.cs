...
namespace Supermercado_APP.Models
{
    ...
    public partial class SupermercadoDBEntities : DbContext
    {
        ...
        public DbSet<tblProducto> tblProductos { get; set; }
        public DbSet<tblventadetalle> tblventadetalles { get; set; }
        public DbSet<tblVentaEncabezado> tblVentaEncabezadoes { get; set; }
        public DbSet<tblCargo> tblCargos { get; set; }
        public DbSet<tblCargosPersona> tblCargosPersonas { get; set; }
        public DbSet<tblCiudade> tblCiudades { get; set; }
        public DbSet<tblDepartamento> tblDepartamentos { get; set; }
        public DbSet<tblDireccione> tblDirecciones { get; set; }
        public DbSet<tblPersona> tblPersonas { get; set; }
        public DbSet<tblProveedore> tblProveedores { get; set; }
